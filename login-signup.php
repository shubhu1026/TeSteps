...
<body>
    <h1>Welcome to <br><span class="span-testeps">TeSteps!</span></h1>
    <div class="container">
    <div class="login-signup-box">
        <div class="tab">
            <button class="tablink login-tab active" onclick="openTab(event,'signin')" id="link1">Login</button>
            <button class="tablink signup-tab" onclick="openTab(event,'signup')" id="link2">Sign Up</button>
        </div>
        <div class="content">
